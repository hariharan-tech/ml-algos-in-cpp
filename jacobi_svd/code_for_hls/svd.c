void matrix_2x2_mul_loop(float* mat1,float* mat2, float* op_mat){
...
void matrix_2x2_mul_hc(float* mat1, float* mat2, float* op_mat){
...
void transpose2x2(float* ip_mat, float* op_mat){
    op_mat[0] = ip_mat[0];
    op_mat[3] = ip_mat[3];
    op_mat[1] = ip_mat[2];
    op_mat[2] = ip_mat[1];
